    ...
    $("#myform").submit(function(){
       ...
       var author = "";
          ...
          $.get("https://www.googleapis.com/books/v1/volumes?q=" + search,function(response){
           ...
           {
            title=$('<h5 class="left-align white-text">' + response.items[i].volumeInfo.title + '</h5>');  
            author=$('<h5 class="left-align white-text"> By:' + response.items[i].volumeInfo.authors + '</h5>');
